...
export default async function AdminPage() {
  ...
  const [clinicCount, userCount, patientCount, jobOfferCount] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-slate-900">Administration plateforme</h2>

      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardContent className="pt-4">
            <p className="text-sm text-slate-500">Cabinets</p>
            <p className="mt-1 text-3xl font-bold text-slate-900">{clinicCount}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4">
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <p className="mt-1 text-3xl font-bold text-slate-900">{jobOfferCount}</p>
          </CardContent>
        </Card>
      </div>
    </div>
